...
<body>
	...
	<table width="98%" border="0" align="center" cellpadding="0"
		cellspacing="1" class="TableBorder">
		<tr>
			<td height="30" align="center" class="TableTitle1"><strong>一级分类管理</strong>
			</td>
		</tr>
		<tr>
			<td height="44" class="TableRow2"><table border="0"
				...
				<form name="form1" action="CategorizationManage?action=updatelocation&locationid=${location.buildingNum }" method="post">
				<table width="90%" border="0" align="center" cellpadding="1"
					...
					<c:forEach var="location" items="${requestScope.allLocations }">
						<tr>
							<td><div align="center">
									<input name="building" type="text" id="building" size="20"
										value="${location.buildingNum }"> &nbsp;[<A href="CategorizationManage?action=detaillocation&locationid=${location.buildingNum }">子目录</A>]
								</div>
							</td>
							<td><div align="center">
